...
// JZBorderedView
#define COCOAPODS_POD_AVAILABLE_JZBorderedView
#define COCOAPODS_VERSION_MAJOR_JZBorderedView 0
#define COCOAPODS_VERSION_MINOR_JZBorderedView 0
#define COCOAPODS_VERSION_PATCH_JZBorderedView 5
